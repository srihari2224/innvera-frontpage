    ...
    <div className="relative border-t border-white/15 group">
      ...
      {as === "textarea" ? (
        ...
        <div className="relative">
          <select
            {...(sharedProps as any)}
            className="w-full bg-transparent text-[1rem] font-medium pb-4 pt-1 outline-none text-white border-none appearance-none cursor-pointer pr-8"
            style={{ caretColor: "#ff6b47" }}
          >
            <option value="" disabled className="bg-[#050505] text-[#666]">Select an option</option>
            <option value="managed" className="bg-[#050505] text-white">Model A — Fully Managed Kiosk (Zero Investment)</option>
            <option value="ownership" className="bg-[#050505] text-white">Model B — Own the Kiosk (₹85,000 + GST)</option>
            <option value="pilot" className="bg-[#050505] text-white">60-Day Free Pilot Program</option>
            <option value="demo" className="bg-[#050505] text-white">Just a Demo First</option>
            <option value="other" className="bg-[#050505] text-white">General Enquiry</option>
          </select>
          {/* Custom dropdown arrow */}
          <div className="absolute right-0 bottom-4 pointer-events-none transition-transform duration-300" style={{ color: focused ? "#ff6b47" : "#666" }}>
            <svg viewBox="0 0 20 20" fill="none" width="14" height="14">
              <path d="M5 8L10 13L15 8" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
            </svg>
          </div>
        </div>
      ) : (
